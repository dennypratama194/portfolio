  ...
  <div class="nav-overlay" id="nav-overlay" aria-hidden="true" inert>
    <nav class="nav-overlay-links" aria-label="Site menu">
      ...
      <!-- Showcase hidden until tested — restore this line and renumber Contact to 05 to bring it back
      <a class="nav-overlay-link" href="/showcase"><span class="nav-overlay-num">04</span><span class="nav-overlay-label">Showcase</span></a>
      -->
    ...
    <div class="nav-overlay-footer">
      <div class="nav-overlay-footer-left">
        <span class="nav-overlay-footer-label">Get in touch</span>
        <a class="nav-overlay-cta js-open-modal" href="#">Start a project →</a>
      </div>
      <div class="nav-overlay-footer-right">
        <span class="nav-overlay-footer-label">Email</span>
        <a class="nav-overlay-email" href="mailto:hello@dennypratama.com">hello@dennypratama.com</a>
      </div>
    </div>
  </div>
